...
from c_binder_mojo.ast.attributes import AttributeVariant
from c_binder_mojo.ast.comments import CommentVariant
...
struct FunctionDeclNode(AstNodeLike):
    ...
    fn to_string(self, just_code: Bool) raises -> String:
        ...
        for child in self.children():
            if child.is_in[*CommentVariant.Ts]():
                comment += child.to_string(just_code)
                continue
            if child.is_in[*AttributeVariant.Ts]():
                continue
