...
# First Party Modules
from c_binder_mojo.common import TokenBundle, NodeIndices, TokenBundles, NodeState, List, CTokens
...
struct WhitespaceNode(NodeAstLike):
    ...
    fn __init__(out self, indicies: NodeIndices, token_bundle: TokenBundle):
        ...
        self._node_state = NodeState.COMPLETE  # Whitespace is always immediately complete
    ...
    fn name(self, include_sig: Bool = False) -> String:
        ...
        if include_sig:
            return self.__name__ + "(" \
                ...
                + "n_tokens=" + String(len(self._token_bundles[])) + ")"
        else:
            return self.__name__
