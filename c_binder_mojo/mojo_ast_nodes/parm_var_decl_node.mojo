...
struct ParmVarDeclNode(NodeAstLike):
    ...
    fn process(
        ...
        if token_flow == TokenFlow.CREATE_CHILD:
            ...
            self._parm_var_decl = String(self._ast_entries[])
            self._node_state = NodeState.COMPLETED
    ...
    fn to_string(
        ...
        return default_to_string(
            ...
            alternate_string=String(self._parm_var_decl) if just_code else String(),
        )
