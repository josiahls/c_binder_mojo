...
@fieldwise_init
struct TranslationUnitDeclNode(NodeAstLike):
    alias __name__ = "TranslationUnitDeclNode"
    var _indicies: ArcPointer[NodeIndices]
    var _ast_entries: ArcPointer[AstEntries]
    var _node_state: MessageableEnum
    var _translation_unit_decl_level: Int
    ...
    fn accept(
        ...
        return ast_entries.ast_name == "TranslationUnitDecl"
    ...
    fn determine_token_flow(
        ...
        if ast_entry.level <= self._translation_unit_decl_level:
