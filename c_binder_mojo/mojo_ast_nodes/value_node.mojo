...
struct ValueNode(NodeAstLike):
    ...
    fn to_string(
        ...
        # NOTE: I think ValueNode needs to be manaully pulled apart by the parent node.
        # We otherwise don't know if we should do  a `type = value` etc.
        return ""
