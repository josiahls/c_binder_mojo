...
struct MacroIfNDefNode(NodeAstLike):
    """Represents a #ifndef preprocessor directive in Mojo code.
    ...
    fn format_token_bundles(mut self):
        """Convert C-style ifdef tokens to Mojo-style tokens."""
    ...
    fn accept(
        ...
        """
        return c_node.name() == "MacroIfNDefNode"
