RootNode(c_node_idx=0, c_parent_idx=0, mojo_node_idx=0, mojo_parent_idx=-1, mojo_children_idxs=(1, 2, 37, 38, 40) 
	...
	StructNode >>> struct mjVisual_: 
		...
		WhitespaceNode >>>   
		StructFieldNode(name=global, type=mjVisual__global, c_node_idx=7, c_parent_idx=3, mojo_node_idx=7, mojo_parent_idx=3, c_children_idxs=(8), mojo_children_idxs=(8)) 
		StructFieldNode >>> var global: mjVisual__global 
			StructNode(name=mjVisual__global, c_node_idx=8, c_parent_idx=7, mojo_node_idx=8, mojo_parent_idx=7, c_children_idxs=(9), mojo_children_idxs=(9)) 
		...
		WhitespaceNode >>>  
		WhitespaceNode >>>   
		StructFieldNode(name=quality, type=mjVisual__quality, c_node_idx=22, c_parent_idx=3, mojo_node_idx=22, mojo_parent_idx=3, c_children_idxs=(23), mojo_children_idxs=(23)) 
		StructFieldNode >>> var quality: mjVisual__quality 
			StructNode(name=mjVisual__quality, c_node_idx=23, c_parent_idx=22, mojo_node_idx=23, mojo_parent_idx=22, c_children_idxs=(24), mojo_children_idxs=(24)) 
