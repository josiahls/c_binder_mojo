RootNode(c_node_idx=0, c_parent_idx=0, mojo_node_idx=0, mojo_parent_idx=-1, mojo_children_idxs=(1, 2, 3, 4, 5, 6, ...) len=18) 
	...
	MacroIfNDefNode >>> #ifndef MUJOCO_MJMODEL_H_ 
		...
		EnumNode >>> #  enum mjtTextureRole_ 
			...
			PlaceHolderNode >>> } mjtTextureRole ;  
			PlaceHolderNode >>>  
			PlaceHolderNode >>>  
			PlaceHolderNode >>> typedef enum mjtIntegrator_ {     
		...
		EnumNode >>> #  enum mjtConstraintState_ 
