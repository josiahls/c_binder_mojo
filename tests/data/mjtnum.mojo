RootNode(c_node_idx=0, c_parent_idx=0, mojo_node_idx=0, mojo_parent_idx=-1, mojo_children_idxs=(1, 2, 3, 4, 5, 6, ...) len=18) 
	...
	MacroIfNDefNode >>> #ifndef MUJOCO_INCLUDE_MJTNUM_H_ 
		...
		MacroIfNDefNode >>> #ifndef mjUSESINGLE 
			...
			DeletedNode >>>   
			DeletedNode(c_node_idx=23, c_parent_idx=21, mojo_node_idx=23, mojo_parent_idx=21, c_children_idxs=(24, 25), mojo_children_idxs=(24)) 
			DeletedNode >>> alias mjtNum = Float64 
			...
			DeletedNode >>>  
			DeletedNode >>>   
			DeletedNode(c_node_idx=27, c_parent_idx=21, mojo_node_idx=26, mojo_parent_idx=21) 
			DeletedNode >>> alias mjMINVAL = 1E-15 
			DeletedNode(c_node_idx=28, c_parent_idx=21, mojo_node_idx=27, mojo_parent_idx=21) 
			DeletedNode >>> # minimum value in any denominator 
			...
			MacroElseNode >>> #else 
				...
				WhitespaceNode >>>   
				TypedefNode(alias=mjtNum, c_node_idx=31, c_parent_idx=29, mojo_node_idx=30, mojo_parent_idx=28, c_children_idxs=(32, 33), mojo_children_idxs=(31)) 
				TypedefNode >>> alias mjtNum = Float32 
				...
				WhitespaceNode >>>  
				WhitespaceNode >>>   
				MacroDefineNode(macro=mjMINVAL, value=1E-15f, c_node_idx=35, c_parent_idx=29, mojo_node_idx=33, mojo_parent_idx=28) 
				MacroDefineNode >>> alias mjMINVAL = 1E-15f 
				MultiLineCommentNode(c_node_idx=36, c_parent_idx=29, mojo_node_idx=34, mojo_parent_idx=28) 
				MultiLineCommentNode >>> #   This does after the float is defined 
