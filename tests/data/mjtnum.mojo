...
PlaceHolderNode(parent_idx=0,current_idx=15) #ifndef MUJOCO_INCLUDE_MJTNUM_H_ 
...
PlaceHolderNode(parent_idx=15,current_idx=20) #ifndef mjUSESINGLE 
...
PlaceHolderNode(parent_idx=15,current_idx=28) #else 
WhitespaceNode(current_idx=29,parent_idx=15)   
PlaceHolderNode(parent_idx=15,current_idx=30) typedef <children> mjtNum ; 
PlaceHolderNode(parent_idx=30,current_idx=31) float 
PlaceHolderNode(parent_idx=15,current_idx=0) mjtNum 
WhitespaceNode(current_idx=33,parent_idx=15)  
  
PlaceHolderNode(parent_idx=15,current_idx=34) #define mjMINVAL    1E-15f 
PlaceHolderNode(parent_idx=15,current_idx=35) /* This does after the float is defined */ 
PlaceHolderNode(parent_idx=0,current_idx=36) #endif 
WhitespaceNode(current_idx=37,parent_idx=0)  
PlaceHolderNode(parent_idx=0,current_idx=38) /* silly comment */ 
PlaceHolderNode(parent_idx=0,current_idx=39) /** another one??????? **/ 
WhitespaceNode(current_idx=40,parent_idx=0)  
PlaceHolderNode(parent_idx=0,current_idx=41) /**  
So  
many  
lines 
...
PlaceHolderNode(parent_idx=0,current_idx=45) typedef <children> mjtByte ; 
PlaceHolderNode(parent_idx=45,current_idx=46) unsigned char 
PlaceHolderNode(parent_idx=0,current_idx=0) mjtByte 
...
PlaceHolderNode(parent_idx=0,current_idx=51) #endif 
