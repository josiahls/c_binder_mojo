RootNode(c_node_idx=0, c_parent_idx=0, mojo_node_idx=0, mojo_parent_idx=-1, mojo_children_idxs=1, 2, 3, 4, 5, 6, ... len=18) 
	...
	MacroIfNDefNode(c_node_idx=15, c_parent_idx=0, mojo_node_idx=15, mojo_parent_idx=0, c_children_idxs=16, 17, 18, 19, 20, 21, ... len=18, mojo_children_idxs=16, 17, 18, 19, 20, 21, ... len=18) #ifndef MUJOCO_INCLUDE_MJTNUM_H_ <children> 
		...
		MacroIfNDefNode(c_node_idx=21, c_parent_idx=15, mojo_node_idx=21, mojo_parent_idx=15, c_children_idxs=22, 23, 26, 27, 28, 29... len=6, mojo_children_idxs=22, 23, 25, 26, 27, 28... len=6) #ifndef mjUSESINGLE <children> 
			...
			TypedefNode(type=<children>, alias=mjtNum, c_node_idx=23, c_parent_idx=21, mojo_node_idx=23, mojo_parent_idx=21, c_children_idxs=24, 25, mojo_children_idxs=24) alias mjtNum = <children> 
			PlaceHolderNode(c_node_idx=24, c_parent_idx=23, mojo_node_idx=24, mojo_parent_idx=23) double 
			WhitespaceNode(c_node_idx=26, c_parent_idx=21, mojo_node_idx=25, mojo_parent_idx=21)  
			  
			MacroDefineNode(macro=mjMINVAL, value=1E-15, c_node_idx=27, c_parent_idx=21, mojo_node_idx=26, mojo_parent_idx=21) alias mjMINVAL = 1E-15 
			SingleLineCommentNode(c_node_idx=28, c_parent_idx=21, mojo_node_idx=27, mojo_parent_idx=21) # minimum value in any denominator 
			MacroElseNode(c_node_idx=29, c_parent_idx=21, mojo_node_idx=28, mojo_parent_idx=21, c_children_idxs=30, 31, 34, 35, 36, mojo_children_idxs=29, 30, 32, 33, 34) #else 
				...
				DeletedNode(c_node_idx=31, c_parent_idx=29, mojo_node_idx=30, mojo_parent_idx=28, c_children_idxs=32, 33, mojo_children_idxs=31) alias mjtNum = <children> 
				# TypedefNode(type=<children>, alias=mjtNum, c_node_idx=31, c_parent_idx=29, mojo_node_idx=30, mojo_parent_idx=28, c_children_idxs=32, 33, mojo_children_idxs=31) Deleted because parent macro was defined
				DeletedNode(c_node_idx=32, c_parent_idx=31, mojo_node_idx=31, mojo_parent_idx=30) float 
				# PlaceHolderNode(c_node_idx=32, c_parent_idx=31, mojo_node_idx=31, mojo_parent_idx=30) Deleted because parent macro was defined
				DeletedNode(c_node_idx=34, c_parent_idx=29, mojo_node_idx=32, mojo_parent_idx=28)  
				  
				# WhitespaceNode(c_node_idx=34, c_parent_idx=29, mojo_node_idx=32, mojo_parent_idx=28) Deleted because parent macro was defined
				DeletedNode(c_node_idx=35, c_parent_idx=29, mojo_node_idx=33, mojo_parent_idx=28) alias mjMINVAL = 1E-15f 
				# MacroDefineNode(macro=mjMINVAL, value=1E-15f, c_node_idx=35, c_parent_idx=29, mojo_node_idx=33, mojo_parent_idx=28) Deleted because parent macro was defined
				DeletedNode(c_node_idx=36, c_parent_idx=29, mojo_node_idx=34, mojo_parent_idx=28) /* This does after the float is defined */ 
				# PlaceHolderNode(c_node_idx=36, c_parent_idx=29, mojo_node_idx=34, mojo_parent_idx=28) Deleted because parent macro was defined
		...
		PlaceHolderNode(c_node_idx=39, c_parent_idx=15, mojo_node_idx=37, mojo_parent_idx=15) /** another one??????? **/ 
		WhitespaceNode(c_node_idx=40, c_parent_idx=15, mojo_node_idx=38, mojo_parent_idx=15)  
		PlaceHolderNode(c_node_idx=41, c_parent_idx=15, mojo_node_idx=39, mojo_parent_idx=15) /**  
		So  
		many  
		lines 
		...
		**/ 
		...
		TypedefNode(type=<children>, alias=mjtByte, c_node_idx=45, c_parent_idx=15, mojo_node_idx=43, mojo_parent_idx=15, c_children_idxs=46, 47, mojo_children_idxs=44) alias mjtByte = <children> 
		PlaceHolderNode(c_node_idx=46, c_parent_idx=45, mojo_node_idx=44, mojo_parent_idx=43) unsigned char 
