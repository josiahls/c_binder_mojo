	...
	MacroIfNDefNode(c_node_idx=15, c_parent_idx=0, mojo_node_idx=15, mojo_parent_idx=0, c_children_idxs=16, 17, 18, 19, 20, 36, ... len=17, mojo_children_idxs=16, 17, 18, 19, 20, 34, ... len=17) #ifndef MUJOCO_INCLUDE_MJTNUM_H_ <children> 
		...
		MacroIfNDefNode(c_node_idx=20, c_parent_idx=15, mojo_node_idx=20, mojo_parent_idx=15, c_children_idxs=21, 22, 25, 26, 27, 28... len=6, mojo_children_idxs=21, 22, 24, 25, 26, 27... len=6) #ifndef mjUSESINGLE <children> 
			...
			MacroElseNode(c_node_idx=28, c_parent_idx=20, mojo_node_idx=27, mojo_parent_idx=20, c_children_idxs=29, 30, 33, 34, 35, mojo_children_idxs=28, 29, 31, 32, 33) #else 
				DeletedNode(c_node_idx=29, c_parent_idx=28, mojo_node_idx=28, mojo_parent_idx=27)   
				# WhitespaceNode(c_node_idx=29, c_parent_idx=28, mojo_node_idx=28, mojo_parent_idx=27) Deleted because parent macro was defined
				DeletedNode(c_node_idx=30, c_parent_idx=28, mojo_node_idx=29, mojo_parent_idx=27, c_children_idxs=31, 32, mojo_children_idxs=30) typedef <children> mjtNum ; 
				# PlaceHolderNode(c_node_idx=30, c_parent_idx=28, mojo_node_idx=29, mojo_parent_idx=27, c_children_idxs=31, 32, mojo_children_idxs=30) Deleted because parent macro was defined
				DeletedNode(c_node_idx=31, c_parent_idx=30, mojo_node_idx=30, mojo_parent_idx=29) float 
				# PlaceHolderNode(c_node_idx=31, c_parent_idx=30, mojo_node_idx=30, mojo_parent_idx=29) Deleted because parent macro was defined
				DeletedNode(c_node_idx=33, c_parent_idx=28, mojo_node_idx=31, mojo_parent_idx=27)  
				  
				# WhitespaceNode(c_node_idx=33, c_parent_idx=28, mojo_node_idx=31, mojo_parent_idx=27) Deleted because parent macro was defined
				DeletedNode(c_node_idx=34, c_parent_idx=28, mojo_node_idx=32, mojo_parent_idx=27) #define mjMINVAL    1E-15f 
				# PlaceHolderNode(c_node_idx=34, c_parent_idx=28, mojo_node_idx=32, mojo_parent_idx=27) Deleted because parent macro was defined
				DeletedNode(c_node_idx=35, c_parent_idx=28, mojo_node_idx=33, mojo_parent_idx=27) /* This does after the float is defined */ 
				# PlaceHolderNode(c_node_idx=35, c_parent_idx=28, mojo_node_idx=33, mojo_parent_idx=27) Deleted because parent macro was defined
