...
fn test_ifdef_node() raises:
    ...
    # Generate Mojo AST
    var mojo_tree_log_file = output_dir / "test_ifdef_node_mojo.tree"
    ...
    var mojo_ast_file_just_code = output_dir / "test_ifdef_node.mojo"
    ...
    var mojo_ast_file = output_dir / "test_ifdef_node.mojo_ast"
