...
alias inner_guard_variable: Int32 =  42 # `inner_guard_variable` was not originally const in the original code

alias outer_guard_variable: Int32 =  100 # `outer_guard_variable` was not originally const in the original code

alias test_function = fn () -> NoneType

alias complex_variable: Int32 =  200 # `complex_variable` was not originally const in the original code
