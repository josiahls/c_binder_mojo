...
fn test_struct_node() raises:
    ...
    # Generate Mojo AST
    var mojo_tree_log_file = output_dir / "test_struct_node_mojo.tree"
    ...
    var mojo_ast_file_just_code = output_dir / "test_struct_node.mojo"
    ...
    var mojo_ast_file = output_dir / "test_struct_node.mojo_ast"
